...
IMAGE=/home/jib/Downloads/fedora-coreos-40.20240701.3.0-qemu.x86_64.qcow2

IGNITION_CONFIG=/home/jib/cosa/ign-configs/ssh-and-autologin.ign
...
virt-install --connect="qemu:///system" --name="fcos-uki" --vcpus=2 --memory=2048 \
